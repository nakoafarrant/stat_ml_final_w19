...
sanmateo.census.cluster.df <- census.ct.clusters %>% 
  filter(Cluster == census.ct.clusters$Cluster[which(census.ct.clusters$County=="San Mateo")])
...
sanmateo.pc5.cluster.df <- ct.pc5.clusters %>% 
  filter(Cluster == ct.pc5.clusters$Cluster[which(ct.pc5.clusters$County=="San Mateo")])
...
fviz_cluster(list(data = ct.pc5, cluster = ct.pc5.subgrp))
```
