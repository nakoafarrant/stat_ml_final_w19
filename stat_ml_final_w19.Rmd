...
lasso.mse = mean((lasso.pred.test-y.test)^2)
...
The non-zero coefficients for the LASSO model with the best lambda are IncomeErr, Service, OtherTransp, 
...
pred.tree <- prediction(predict.tree.test[,2], trn.cl$candidate)
